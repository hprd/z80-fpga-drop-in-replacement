...
#
# Script generated by Vivado on Thu Feb 19 13:02:00 -0600 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : z80_memory_tb.sh
...
#
# Usage        : z80_memory_tb.sh
#                z80_memory_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                z80_memory_tb.sh [-rerun]
#                z80_memory_tb.sh [-reset_run]
#                z80_memory_tb.sh [-clean]
#                z80_memory_tb.sh [-reset_log]
#                z80_memory_tb.sh [-help]
#
...
# script info
echo -e "z80_memory_tb.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./z80_memory_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_12 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot z80_memory_tb xil_defaultlib.z80_memory_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim z80_memory_tb -key {Behavioral:sim_1:Functional:z80_memory_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb z80_memory_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./z80_memory_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: z80_memory_tb.sh [-help]\n\
Usage: z80_memory_tb.sh [-step]\n\
Usage: z80_memory_tb.sh [-lib_map_path]\n\
Usage: z80_memory_tb.sh [-rerun]\n\
Usage: z80_memory_tb.sh [-reset_run]\n\
Usage: z80_memory_tb.sh [-clean]\n\
Usage: z80_memory_tb.sh [-reset_log]\n\
Usage: z80_memory_tb.sh [-keep_index]\n\
Usage: z80_memory_tb.sh [-noclean_files]\n\n\
