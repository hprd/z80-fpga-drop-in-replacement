...
REM
REM Generated by Vivado on Fri Feb 20 00:38:04 -0600 2026
...
echo "xvlog --incr --relax -prj z80_memory_tb_vlog.prj"
call xvlog  --incr --relax -prj z80_memory_tb_vlog.prj -log xvlog.log
