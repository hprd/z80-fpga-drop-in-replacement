...
HD_PWD='/home/user/Z80_Drop_In_2026/Z80_Drop_In_2026.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_delay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_delay.tcl
